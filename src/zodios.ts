...
export class ZodiosClass<Api extends ZodiosEndpointDefinitions> {
  ...
  async request<M extends Method, Path extends string>(
    ...
    ZodiosResponseByPath<Api, M, Path extends ZodiosPathsByMethod<Api, M> ? Path : never>
  > {
...
export type ZodiosInstance<Api extends ZodiosEndpointDefinitions> = ZodiosClass<Api> &
  ZodiosAliases<Api>
